...
const TEMPLATES: TemplateDef[] = [
  {
    ...
    preview: ["Hero", "Features", "Statistics", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("features", 1),
  ...
  },
  {
    ...
    preview: ["Hero Split", "Stats Counter", "Step Process", "Pricing", "FAQ", "Footer"],
    buildComponents: () => [
  ...
  },
  {
    ...
    preview: ["Video Hero", "Stats Ribbon", "Code Showcase", "Tabbed Features", "Contact", "Footer"],
    buildComponents: () => [
  ...
  },
  {
    ...
    preview: ["Countdown", "Event Agenda", "Portfolio", "Executive Quote", "CTA", "Footer"],
    buildComponents: () => [
  ...
  },
  {
    ...
    preview: ["Hero", "About", "Timeline", "Team", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("about", 1),
      makeComp("timeline", 2),
  ...
  },
  {
    ...
    preview: ["Hero", "Leader Spotlight", "Job Board", "Resources", "Contact", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
  ...
  },
  {
    ...
    preview: ["Banner Alert", "Hero", "Partner Logos", "Comparison", "Testimonials", "Footer"],
    buildComponents: () => [
  ...
  },
  {
    ...
    preview: ["Hero", "Event Agenda", "Gallery", "Contact Form", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("event_schedule", 1),
      makeComp("gallery", 2),
  ...
  },
  {
    ...
    preview: ["Hero", "Mentors", "Testimonials", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("mentors", 1),
  ...
  },
  {
    ...
    preview: ["Hero", "Download Resources", "FAQ Accordion", "Newsletter", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
  ...
  },
  {
    ...
    preview: ["Hero", "Location Map", "Contact Form", "FAQ", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
  ...
  },
  {
    ...
    preview: ["Hero", "News Grid", "Video Showcase", "Newsletter", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
  ...
  },
  {
    ...
    preview: ["Hero", "Gallery", "About", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("gallery", 1),
      makeComp("about", 2),
  ...
  },
  {
    ...
    preview: ["Hero", "Image+Text", "Cards", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),

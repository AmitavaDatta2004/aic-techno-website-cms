...
const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    label: "Event Page",
    icon: "📅",
    description: "Promote an event with details, a gallery, and a contact form.",
    preview: ["Hero", "About", "Cards", "Gallery", "Contact Form", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("about", 1),
      makeComp("cards", 2),
  ...
  },
  {
    ...
    preview: ["Hero", "Image+Text", "Image+Text", "Cards", "CTA", "Footer"],
    buildComponents: () => [
      makeComp("hero", 0),
      makeComp("image_text", 1),
      makeComp("image_text", 2, { layout: "image-right" }),
      makeComp("cards", 3),
      makeComp("cta", 4),
      makeComp("footer", 5),
    ],
